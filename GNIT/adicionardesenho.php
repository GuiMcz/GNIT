...
<body>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="modalLabel">Cancelar adição de desenho</h4>
        </div>
        <div class="modal-body">
          Deseja realmente cancelar adicionar um novo desenho?
        </div>
  ...
  <div class="container-fluid" style="margin-top:80px;">
    <div class="row">
      ...
      <!--Final Menu Esquerdo-->
      <div class="col-md-10">
        <form class="form-horizontal" action="configs/desenho_salvar.php" method="POST">
          <fieldset>


            <legend style="text-align:center;">Preencha os campos abaixo para adicionar um novo desenho industrial</legend>


            <div class="form-group">
              <label class="col-md-4 control-label" for="titulo">Título do desenho</label>
              <div class="col-md-4">
                <input id="textinput" name="titulo" type="text" placeholder="Título do desenho" required="true" class="form-control input-md">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                <select id="selectbasic" name="status" required="true" required="true" class="form-control">
                  ...
                  <option value="5">Redação do desenho</option>
            ...
            <div class="form-group">
              <label class="col-md-4 control-label" for="num_ped">Número de pedido do desenho</label>
              <div class="col-md-4">
                <input id="textinput" name="num_ped" type="text" placeholder="Número do desenho" required="true" class="form-control input-md">
                <span class="help-block">Preencha com o número de pedido do desenho</span>
              </div>
            </div>
