...
$id_pro = $_GET["id_pro"];
$buscar_cadastro = "SELECT * FROM programa_computador WHERE cd_pro = $id_pro";
...
while ($receber_dados = mysqli_fetch_array($query_cadastros)) {
  $nome = $receber_dados['titulo'];
  $status = $receber_dados['status'];
  $tipo = $receber_dados['tipo_pro'];
  $campo = $receber_dados['campo'];
  $ling = $receber_dados['ling'];
  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="propriedades.php"><b>Espaço GNIT</b></a>
      </div>
      ...
      <div class="table-responsive col-md-10">
        <table class="table table-striped" cellspacing="0" cellpadding="0">
          ...
          <div id="main" class="container-fluid">
            ...
            <h3 class="page-header">Dados do Software</h3>

            <div class="row">
              <div class=col-md-12>
                <div class="col-md-4">
                  <p><strong>Nome do Software</strong></p>
                  <p><?php echo $nome; ?></p>
                </div>


                <div class="col-md-4">
                  <p><strong>Status do Software</strong></p>
                  <p><?php echo $status_ptt; ?></p>
                </div>

                <div class="col-md-4">
                  <p><strong>Tipo de Software</strong></p>
                  <p><?php echo $tipo; ?></p>
                </div>
              </div>
              <div class=col-md-12>
                <div class="col-md-4">
                  <p><strong>Campo de Aplicação</strong></p>
                  <p><?php echo $campo; ?></p>
                </div>
              ...
              <div class="col-md-12">
                <hr>
                <p><strong>Código Hash</strong></p>
                <p>CC6FD1BB2627853B0E338A8300621B963C046A8AC0733453A193F4EAB252442C5DC0E6481C2F3C97AC39594D9C9C02EF9DF639785D11CC2C26CD5845E35B0E26</p>
          ...
          <div class="col-md-12">
            <a href="software.php" class="btn btn-primary">Fechar</a>
            <a href="editarsoftware.php?id_pro=<?php echo $id_pro; ?>" class="btn btn-default">Editar</a>
