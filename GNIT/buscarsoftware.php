...
$pesquisa = $_GET['busca'];
$sql_busca = "SELECT * FROM programa_computador WHERE titulo LIKE '%$pesquisa%'";
			...
			<table class="table table-striped" cellspacing="0" cellpadding="0">
				...
				<tbody>
					...
					while ($dados_busca = mysqli_fetch_array($busca_query)) {
						$nome = $dados_busca['titulo'];
						$situacao = $dados_busca['status'];
						$prof_resp = $dados_busca['res_pro'];
						$id_pro = $dados_busca['cd_pro'];
