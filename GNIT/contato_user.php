<html lang="pt-BR">
	<head>
		...
		<meta charset="UTF-8" />
		<title>Espaço NIT - Contato</title>
        <meta charset="UTF-8">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"><b>Espaço NIT</b></a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
         
            <li><a href="index.php">Portfólio</a></li>
            <li><a href="quem_user.php">Quem Somos</a></li>
            <li class="active"><a href="contato_user.php">Contato</a></li>
