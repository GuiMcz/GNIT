...
$buscar_cadastro = "SELECT * FROM programa_computador WHERE ativo = 1";
...
<div class="container-fluid" style="margin-top:80px;">
	<div class="row">
		...
		<div class="col-md-5">
			<form class="form-inline" action="buscarsoftware.php" method="GET">


				<label class="sr-only" for="busca">Digite o que deseja buscar</label>
				<input type="search" name="busca" class="form-control" placeholder="Digite o que deseja buscar">
		...
		<d <div class="table-responsive col-md-10">
			<table class="table table-striped" cellspacing="0" cellpadding="0">
				...
				<div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel">
					<form action="configs/programa_excluir.php" method="POST" id="exc">
				...
				<tbody>
					...
					while ($receber_cadastros = mysqli_fetch_array($query_cadastros)) {
						$nome = $receber_cadastros['titulo'];
						$situacao = $receber_cadastros['status'];
						$prof_resp = $receber_cadastros['res_pro'];
						$id_pro = $receber_cadastros['cd_pro'];
						// $data_format = date('d/m/Y', $data_cad);
						$permissao = '';
						if ($situacao == '1') {
							$permissao = "Software Concedido";
						} else if ($situacao == '2') {
							$permissao = "Software Depositado";
						} else if ($situacao == '3') {
					...
					?>
						<tr>
							...
							<?php
							if ($situacao == '1') {
								echo '<td><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Software Concedido</td>';
							} else if ($situacao == '2') {
								echo '<td><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Software Depositado</td>';
							} else if ($situacao == '3') {
							...
							<td class="actions">
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu">
										<li><a class="btn btn-success btn-xs" href="visualizarsoftware.php?id_pro=<?php echo $id_pro; ?>">Visualizar</a></li>
										<li></li>
										<li><a class="btn btn-warning btn-xs" href="editarsoftware.php?id_pro=<?php echo $id_pro; ?>">Editar</a></li>
										<li><a class="btn btn-danger btn-xs" href="#delete-modal?id_pro=<?php echo $id_pro; ?>" data-toggle="modal" data-target="#delete-modal" data-id="<?php echo $id_pro; ?>">Excluir</a></li>
									</ul>
								</div>
							</td>
						</tr>
