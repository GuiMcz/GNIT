...
$pesquisa = $_GET['busca'];
$sql_busca = "SELECT * FROM desenho_industrial WHERE tit_des LIKE '%$pesquisa%'";
...
<div class="container-fluid" style="margin-top:80px;">
	<div class="row">
		...
		<div class="col-md-5">
			<form class="form-inline" action="buscardesenho.php" method="GET">
			...
			<table class="table table-striped" cellspacing="0" cellpadding="0">
				...
				<tbody>
					...
					while ($dados_busca = mysqli_fetch_array($busca_query)) {
						$nome = $dados_busca['tit_des'];
						$situacao = $dados_busca['status'];
						$prof_resp = $dados_busca['res_des'];
						$id_ptt = $dados_busca['cd_des'];
							...
							<td class="actions">
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu">
										<li><a class="btn btn-success btn-xs" href="visualizardesenho.php?id_pdes=<?php echo $id_des; ?>">Visualizar</a></li>
										<li></li>
