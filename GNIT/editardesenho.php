...
$id_des = $_GET["id_des"];
$sql = "SELECT * FROM desenho_industrial WHERE cd_des = $id_des";
$res = $conn->query($sql);
...
<body>
  ...
  <div class="container-fluid" style="margin-top:80px;">
    <div class="row">
      ...
      <!--Final Menu Esquerdo-->
      <div class="col-md-10">
        <form class="form-horizontal" action="configs/desenho_editar.php" method="POST">
          <input type="hidden" name="id" value="<?php print $dados->cd_des; ?>">
          <fieldset>


            <legend style="text-align:center;">Preencha os campos abaixo para editar o desenho</legend>


            <div class="form-group">
              <label class="col-md-4 control-label" for="titulo">Título do desenho</label>
              <div class="col-md-4">
                <input id="titulo" name="titulo" type="text" value="<?php print $dados->tit_des; ?>" required="true" class="form-control input-md">
                <span class="help-block">Título do desenho</span>
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-md-4 control-label" for="tipo">Tipo do desenho </label>
              <div class="col-md-4">
                <select id="selectbasic" name="tipo" required="true" class="form-control">
                  <option value="1" <?php echo $dados->tipo == '1' ? 'selected' : '' ?>>Patente de Invenção</option>
                  <option value="2" <?php echo $dados->tipo == '2' ? 'selected' : '' ?>>Patente de Modelo de Utilidade</option>
                </select>
                <span class="help-block">Selecione o tipo do desenho</span>
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-4 control-label" for="status">Status do desenho</label>
              <div class="col-md-4">
                <select id="selectbasic" name="status" required="true" class="form-control">
                  <option value="1" <?php echo $dados->status == '1' ? 'selected' : '' ?>>Patente Concedida</option>
                  <option value="2" <?php echo $dados->status == '2' ? 'selected' : '' ?>>Patente Depositada</option>
                  ...
                  <option value="5" <?php echo $dados->status == '5' ? 'selected' : '' ?>>Redação do desenho</option>
                  <option value="6" <?php echo $dados->status == '6' ? 'selected' : '' ?>>Buscas</option>

                </select>
                <span class="help-block">Selecione o Status do desenho</span>
              </div>
            </div>
