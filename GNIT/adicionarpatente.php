...
<body>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="modalLabel">Cancelar adição da patente</h4>
        </div>
        <div class="modal-body">
          Deseja realmente cancelar adicionar uma nova patente?
        </div>
  ...
  <div class="container-fluid" style="margin-top:80px;">
    <div class="row">
      ...
      <!--Final Menu Esquerdo-->
      <div class="col-md-10">
        <form class="form-horizontal" action="configs/patente_salvar.php" method="POST">
          <fieldset>


            <legend style="text-align:center;">Preencha os campos abaixo para Adicionar uma nova patente</legend>


            <div class="form-group">
              <label class="col-md-4 control-label" for="titulo">Título da Patente</label>
              <div class="col-md-4">
                <input id="textinput" name="titulo" type="text" placeholder="Título da Patente" required="true" class="form-control input-md">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                <select id="selectbasic" name="status" required="true" required="true" class="form-control">
                  ...
                  <option value="5">Redação da Patente</option>
            ...
            <div class="form-group">
              <label class="col-md-4 control-label" for="num_ped">Número de pedido da Patente</label>
              <div class="col-md-4">
                <input id="textinput" name="num_ped" type="text" placeholder="Número da Patente" required="true" class="form-control input-md">
                <span class="help-block">Preencha com o número de pedido da Patente</span>
              </div>
            </div>
