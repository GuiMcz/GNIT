...
<head>
  ...
  <meta charset="UTF-8" />
  <title>Adicionar Software - GNIT</title>
  <meta charset="UTF-8">
...
<body>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="modalLabel">Cancelar adição do software</h4>
        </div>
        <div class="modal-body">
          Deseja realmente cancelar adicionar um novo software?
        </div>
  ...
  <div class="container-fluid" style="margin-top:80px;">
    <div class="row">
      ...
      <!--Final Menu Esquerdo-->
      <div class="col-md-10">
        <form class="form-horizontal" action="configs/programa_salvar.php" method="POST">
          <fieldset>


            <legend style="text-align:center;">Preencha os campos abaixo para adicionar um novo Software</legend>


            <div class="form-group">
              <label class="col-md-4 control-label" for="titulo">Título do software</label>
              <div class="col-md-4">
                <input id="textinput" name="titulo" type="text" placeholder="Título do software" required="true" class="form-control input-md">
                <span class="help-block">Título do software</span>
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-md-4 control-label" for="tipo">Tipo do software </label>
              <div class="col-md-4">
                <select id="selectbasic" name="tipo" required="true" class="form-control">
                  <option value="1">Patente de Invenção</option>
                  <option value="2">Patente de Modelo de Utilidade</option>
                </select>
                <span class="help-block">Selecione o tipo do software</span>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-4">
                <select id="selectbasic" name="status" required="true" required="true" class="form-control">
                  <option value="1">Software Concedido</option>
                  <option value="2">Software Depositado</option>
                  <option value="3">Acompanhamento Revista</option>
                  <option value="4">Esperando Contabilidade</option>
                  <option value="5">Redação do software</option>
            ...
            <!-- <div class="form-group">
              <label class="col-md-4 control-label" for="num_ped">Número de pedido do software</label>
              <div class="col-md-4">
                <input id="textinput" name="num_ped" type="text" placeholder="Número do software" required="true" class="form-control input-md">
                <span class="help-block">Preencha com o número de pedido do software</span>
              </div>
            </div> -->

            <div class="form-group">
              <label class="col-md-4 control-label" for="ling">Linguagem de programação do software</label>
              <div class="col-md-4">
                <input id="textinput" name="ling" type="text" required="true" class="form-control input-md">
                <span class="help-block">Preencha com a linguagem utilizada</span>
              </div>
            </div>

            <div class="form-group">
              <label class="col-md-4 control-label" for="campo">Campo de aplicação</label>
              <div class="col-md-4">
                <input id="textinput" name="campo" type="text" required="true" class="form-control input-md">
                <span class="help-block">Preencha com o campo de aplicação do software</span>
              </div>
            </div>
