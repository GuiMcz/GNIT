...
$id_ptt = $_GET["id_ptt"];
$buscar_cadastro = "SELECT * FROM patente WHERE cd_ptt = $id_ptt";
$query_cadastros = mysqli_query($conn, $buscar_cadastro);

// Query para busca na tabela de Patente
while ($receber_dados = mysqli_fetch_array($query_cadastros)) {
  $nome = $receber_dados['tit_ptt'];
  $status = $receber_dados['sit_ptt'];
  $tipo = $receber_dados['tp_ptt'];
  $tipo_patente = '';
  if ($tipo == '1') {
    $tipo_patente = "Patente de Invenção";
  } else {
    $tipo_patente = "Modelo de Utilidade";
  }
  $status_ptt = '';
  if ($status == '1') {
...
<head>
  ...
  <meta charset="UTF-8" />
  <title>Visualizar Patente - GNIT</title>
  <meta charset="UTF-8">
      ...
      <div class="table-responsive col-md-10">
        <table class="table table-striped" cellspacing="0" cellpadding="0">
          ...
          <div id="main" class="container-fluid">
            ...
            <h3 class="page-header">Dados da Patente</h3>

            <div class="row">
              <div class=col-md-12>
                <div class="col-md-4">
                  <p><strong>Nome da Patente</strong></p>
                  <p><?php echo $nome; ?></p>
                </div>


                <div class="col-md-4">
                  <p><strong>Status da Patente</strong></p>
                  <p><?php echo $status_ptt; ?></p>
                </div>

                <div class="col-md-4">
                  <p><strong>Tipo de Patente</strong></p>
                  <p><?php echo $tipo_patente; ?></p>
                </div>
              </div>
              <div class=col-md-12>
                <hr>
          ...
          <div class="col-md-12">
            <a href="patente.php" class="btn btn-primary">Fechar</a>
            <a href="editarpatente.php?id_ptt=<?php echo $id_ptt; ?>" class="btn btn-default">Editar</a>
